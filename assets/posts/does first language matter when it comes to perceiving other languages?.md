# Does first language matter when it comes to perceiving other languages?
...
a) the words are far apart in the embedding tensor: they are used differently in local texts

b) the model isn't using the word appropriately.
