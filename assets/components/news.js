  ...
  connectedCallback() {
    this.innerHTML = `
        <div class="news-box" style="border: 2px #000000; width: 95%; max-width: 9in;color: #000000; margin-top: 50x; margin-bottom: 10px;
			    ...
			    <h3 style="margin-top: 0; font-size: 1.2em; font-weight: 300; font-family: 'Calibri Light', Helvetica, Calibri, Arial, sans-serif; color: #000000ff;">news / upcom!ng <hr style="border: 0.001px solid #3333332a"/> </h3>
