class Name extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        ...
        <img id="name-image" src="assets/name_latin.svg" alt="Ridhi Bandaru" style="height:50px; cursor: pointer;"/>
      </div>
    ...
    this.querySelector('#name-image').addEventListener('click', () => {
      ...
      if (img.src.includes('name_latin.svg')) {
        img.src = 'assets/name_brahmi.svg';
      } else {
        img.src = 'assets/name_latin.svg';
      }
    });
  }
}
